...
<math xmlns="https://render.githubusercontent.com/render/math?math=  e^{i \pi} =-1">

<math xmlns="http://www.w3.org/1998/Math/MathML"  alttext="{\displaystyle {\text{s}}=\int _{a}^{b}{\sqrt {\mathrm {d} x^{2}+\mathrm {d} y^{2}}}=\int _{a}^{b}{\sqrt {1+y'^{2}}}\,\mathrm {d} x,}">
